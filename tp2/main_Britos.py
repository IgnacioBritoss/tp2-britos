from funciones_Britos import protocolo_inicio, calcular_combustible, chequeo_sistema, calcular_estadisticas
protocolo_inicio()
capitan = input("Nombre del capitan/a:")
print()

cantidad_sistemas = int(input("Cuantos sistemas queres inspeccionar?"))
print()
aprobados = 0
fallidos = 0
contador = 1
...
while contador <= cantidad_sistemas:
    ...
    while nivel_energia < 0 or nivel_energia > 100:
        print("Error: el nivel de energia debe ser entre 0 y 100.")
        nivel_energia = int(input("Ingresa de nuevo el nivel de energia: "))
...
carga_base = int(input("Ingresa la carga base de combustible:"))
